<section class="mv-home-hero" markdown>
...
कृपया [योगदान मार्गदर्शिका](contributing.md) और [आचार संहिता](code-of-conduct.md) पढ़ें। सभी योगदान UTF-8 Markdown में, citations के साथ, और source-separation policy का पालन करते हुए करें।
